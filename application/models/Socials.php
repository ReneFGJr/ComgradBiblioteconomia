...
class socials extends CI_Model {
		...
		if (isset($_SESSION['user']) and (strlen($_SESSION['user']) > 0)) {
			...
			$sx = '
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item" href="' . base_url('index.php/main/show_perfil') . '">' . msg('user_perfil') . '</a>
                    <a class="dropdown-item" href="' . base_url('index.php/social/logout') . '">' . msg('user_logout') . '</a>
                </div>                
                ';
		} else {
    ...
    function user_email_send($para, $nome, $code) {
        ...
        switch($code) {
            case 'SIGNUP' :
                $link = base_url('index.php/social/npass/?dd0=' . $para . '&chk=' . checkpost_link($para . $para));
            ...
            case 'PASSWORD' :
                ...
                $link = base_url('index.php/user_password_new/?dd0=' . $para . '&chk=' . checkpost_link($para . date("Ymd")));
   ...
   function show_perfil($id=0)
        {
            $data = $this->le($id);
            $sx = $this->load->view('login/show',$data,true);
            return($sx);
        }
}
?>